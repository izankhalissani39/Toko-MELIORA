...
const CATEGORIES = ['Semua', 'Minuman', 'Buah-buahan'];
export const InventoryManager = ({ products, onAddProduct, onUpdateProduct, onDeleteProduct, onQuickAdjustStock, }) => {
