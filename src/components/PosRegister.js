...
export const PosRegister = ({ products, cart, setCart, storeSettings, onOpenPayment, heldOrders, onHoldOrder, onRestoreHeldOrder, onDeleteHeldOrder, onOpenCameraScanner, }) => {
