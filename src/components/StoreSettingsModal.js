...
export const StoreSettingsModal = ({ isOpen, onClose, settings, onSaveSettings, onResetToDemo, products, transactions, currentShift, heldOrders, onImportData, }) => {
